export default {
    ...
    sendActivationCodeNextButton: 'Next',
    sendActivationCodeReturnButton: 'Return?',
    sendActivationCprNumberPlaceholder: 'CPR number',
    sendActivationCodeDescription: 'Enter your CPR-number and receive an activation code via SMS.',
